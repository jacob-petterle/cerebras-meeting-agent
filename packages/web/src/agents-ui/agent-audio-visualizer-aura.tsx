...
// Vendored from LiveKit's shadcn @agents-ui registry, adapted for our Vite + React-18 + no-Tailwind
// stack: relative imports, size variants dropped (the orb fills its parent), and the React-19
// ref-as-prop removed. The shader + state→animation behavior are unchanged (faithful Aura).
